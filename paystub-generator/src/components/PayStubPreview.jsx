    ...
    <div id="paystub-preview" className={`bg-white border-2 ${t.border} rounded-2xl overflow-hidden print:border-gray-400`}>
      ...
      <div className="px-6 py-3 bg-gray-50 border-t border-gray-200">
        <p className="text-xs text-gray-400 text-center">
          Generated by MyFreePayStub.com from user-entered figures · Estimate for personal record-keeping only ·
          Not an official payroll document and not issued or verified by any employer
        </p>
      </div>
    </div>
  )
