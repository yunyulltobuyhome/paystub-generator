export default function About() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-black text-gray-800 mb-2">About PayStubFree</h1>
      ...
      <div className="space-y-8 text-sm text-gray-600">
        <section className="bg-blue-50 border border-blue-200 rounded-xl p-5">
          <h2 className="text-base font-bold text-blue-800 mb-3">What is PayStubFree?</h2>
          <p className="leading-relaxed text-blue-700">
            PayStubFree is a free online pay stub generator built for US employees, freelancers,
        ...
        <section>
          ...
          <p className="leading-relaxed">
            ...
            of their earnings, that's unnecessary. PayStubFree was built to provide a genuinely
        ...
        <section>
          ...
          <p className="leading-relaxed">
            PayStubFree is supported by Google AdSense advertising — small, non-intrusive ads
        ...
        <section>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-xs text-amber-800">
            ...
            <p className="leading-relaxed">
              PayStubFree is not a licensed payroll provider, tax adviser, or financial services company.
